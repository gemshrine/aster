...
not_configured ──save_settings──► connecting ──Welcome──► connected
                          ...
                          backoff ────┘   │ сеть/таймаут      │ сеть/таймаут/close
                                          ▼                   ▼
                                     reconnecting ◄───────────┘
connecting/connected ──Rejected──► failed{invalid_token|unsupported_protocol_version}
...
| `disconnected` | — |
| `failed` | `reason: "invalid_token" \| "unsupported_protocol_version" \| "session_replaced"` |
